" Source: https://github.com/vim-scripts/Spacegray.vim/blob/master/colors/spacegray.vim
" its a bit modified
"
hi clear
...
hi NonText         ctermbg=NONE ctermfg=237    guibg=NONE     guifg=#515F6A  cterm=NONE      gui=NONE
...
hi SpecialKey      ctermbg=NONE ctermfg=237    guibg=NONE     guifg=#515F6A  cterm=NONE      gui=NONE
...
hi DiagnosticError ctermbg=NONE ctermfg=1      guibg=NONE     guifg=#CF7B98  cterm=NONE      gui=NONE
hi DiagnosticWarn  ctermbg=NONE ctermfg=3      guibg=NONE     guifg=#FFFA6A  cterm=NONE      gui=NONE
hi DiagnosticInfo  ctermbg=NONE ctermfg=6      guibg=NONE     guifg=#99D6FC  cterm=NONE      gui=NONE
hi DiagnosticHint  ctermbg=NONE ctermfg=6      guibg=NONE     guifg=#99D6FC  cterm=NONE      gui=NONE
...
hi LineNr          ctermbg=237  ctermfg=8      guibg=#111314  guifg=#3E4853  cterm=NONE      gui=NONE
...
hi Folded          ctermbg=0    ctermfg=2      guibg=bg       guifg=#808080
